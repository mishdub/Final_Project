        ...
        if extended_poly.intersects(convex_exterior):
            ...
            if intersection.is_empty:
                ...
                if intersection.geom_type == "Polygon":
                    ...
                    f_p1, t_p1, list_of_points1, list_of_l1, dis1 = self.move_poly_MultiLineString2(original_polygon, angle, intersection.geoms)
                    f_p2, t_p2, list_of_points2, list_of_l2, dis2 = self.move_poly_MultiLineString(original_polygon, angle, intersection.geoms)
                    if dis1 < dis2:
                        f_p = f_p1
                        t_p = t_p1
