                                            ...
                                            for point in points:
                                                ...
                                                while True:
                                                    ...
                                                    if dex >= 4:
                                                        cl = []
                                                        cl2 = []
                                                        cl2.append([point, (xxx, yyy)])
                                                        before4 = copy.deepcopy(polygon)
                                                        before3 = copy.deepcopy(polygon)

                                                        bigrec = copied_rec.extend_polygon(1.1)

                                                        before4.set_coordinates(big_p)
                                                        before3.set_coordinates(bigrec)

                                                        another_list.append(before4)
                                                        another_list.append(before3)
                                                ...
                                                if dex >= 4:
                                                    ...
                                                    cl2 = []
                                                    cl.append(the_a)
                                                    before2 = copy.deepcopy(polygon)
                                                    another_list.append(before2)
                                                    before3 = copy.deepcopy(polygon)
                                                    big_p4 = copied_rec.extend_polygon(1.1)
                                                    before4 = copy.deepcopy(polygon)
                                                    before4.set_coordinates(big_p4)


                                                    before3.set_coordinates(list(extended_poly.exterior.coords))
                                                    another_list.append(before3)
                                                    another_list.append(before4)
                                            ...
                                            for point in points:
                                                ...
                                                while True:
                                                    ...
                                                    if dex >= 3:
                                                        ...
                                                        big_p2 = self.polygon_to_rectangle(big_p)
                                                        cl = []
                                                        cl2 = []
                                                        cl2.append([point, (xxx, yyy)])
                                                        before4 = copy.deepcopy(polygon)
                                                        ...
                                                        before4.set_coordinates(big_p)
                                                        before2.set_coordinates(big_p2)
