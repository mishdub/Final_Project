...
class Algo23:
    ...
    def temp_func(self, polygon, p_of_convex, p_of_middle,convex_region,best_a):
        ...
        proj_p = self.project_point_to_linestring_edge_new(new_line, best_a)
        #proj_p = self.project_point_to_convex_edge(convex_region_original, p_of_convex)
        poi.append(proj_p)
        poi.append(p_of_convex)
    ...
    def best_a(self, previous_polygon, polygon):
            ...
            if pol2.within(pol1):
                ...
                if dex >= 1:
                    ...
                    while not flag_temp:
                        ...
                        the_best_a = self.best_a(previous_polygon,polygon)
                        ...
                        for j_index in range(2):
                            ...
                            for point in points:
                                ...
                                if dex >= 11:
                                    line3 = []
                                    line3.append([a, point])
                                    poi.append(a)
                                    poi.append(point)

                                    copied2 = copy.deepcopy(polygon)
                                    copied23 = copy.deepcopy(polygon)
                                    ccoco = self.polygon_to_rectangle2(previous_polygon.coordinates)
                                    copied23.set_coordinates(ccoco)
                                    ...
                                    another_list.append(rec_of_prev_poly_copied)
                                ...
                                if flag:
                                    ...
                                    if j_index == 0:
                                        ...
                                        proj_p = self.temp_func(copiedp, a, point, convex_region_original,the_best_a)
                                        ...
                                        if dex >= 10000:
                                            line3 = []
                                            line3.append([the_best_a, point])
                                            line3.append([p, proj_p])

                                            poi.append(a)
                                            poi.append(proj_p)
                                            poi.append(the_best_a)
                                        ...
                                        rec_temp = Polygon(rec_of_poly_copied.move_from_to2_value(point, p))
                                        if Polygon(rec_temp).within(pol1):
                                            rec_of_poly_copied.move_from_to2(point, p)
