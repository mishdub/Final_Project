...
class Algo19:
    ...
    def check_first_line_string(self, original_polygon, extended_poly, convex_region, angle):
        convex_exterior = Polygon(convex_region)
                ...
                if intersection.geom_type == "LineString":
                    ...
                    for (x, y) in list(closest_line.coords):
                        ...
                        for line in list_lines_without_the_closest:
                            if new_line_string.crosses(line):
                                return False
                ...
                if dex >= 1:
                    ...
                    while not flag_temp:
                        ...
                        while not flag000:
                            ...
                            new_flag = self.check_first_line_string(polygon.coordinates, filled_polygon000,
                                                                    convex_region, angle)
                            if dex >= 1000:
                                listtt = []
