    ...
    def intersection_of_lines2(self,vertical_line, horizontal_line, prev_point_of_pol,convex_region):
        ...
        if len1 > len2:
            ...
            if not intersection1.is_empty and not intersection2.is_empty:
                ...
                dis2 = p1.distance(p3)
                if dis1 < dis2:
                    return intersection1.x, intersection1.y, True
                else:
                    return intersection2.x, intersection2.y, True
            elif not intersection1.is_empty:
                return intersection1.x, intersection1.y, True
            elif not intersection2.is_empty:
                return intersection2.x, intersection2.y, True
            elif intersection1.is_empty and intersection2.is_empty:
                return 0, 0, False
            ...
            if not intersection3.is_empty and not intersection4.is_empty:
                ...
                dis2 = p1.distance(p3)
                if dis1 < dis2:
                    return intersection3.x, intersection3.y, True
                else:
                    return intersection4.x, intersection4.y, True
            elif not intersection3.is_empty:
                return intersection3.x, intersection3.y, True
            elif not intersection4.is_empty:
                return intersection4.x, intersection4.y, True
            elif intersection3.is_empty and intersection4.is_empty:
                return 0, 0, False
            ...
            if pol2.within(pol1):
                ...
                if dex >= 1:
                    ...
                    while not flag_temp:
                        ...
                        vertical_line, horizontal_line = self.create_lines2(convex_region)
                        """
                        if dex >= 8:
                        ...
                        new_x, new_y, flag_intersection_of_lines = self.intersection_of_lines2(vertical_line, horizontal_line,
                                                             previous_polygon.left_intersection_point, convex_region_original)


                        sign_yes = False
                        sign_yes_ver2 = False
                        if flag_intersection_of_lines:
                            ...
                            if pol_check.within(pol1):
                                ...
                                middle_point_of_poly = new_x, new_y
                            else:
                                middle_point_of_poly = x, y
                                sign_yes = True
                        else:
                            middle_point_of_poly = x, y
                            sign_yes = True
                        ...
                        while not flag000:
                            ...
                            if not flag000:
                                """
                                dist_temp = ppol1.distance(ppol2)
                                flag0000, (px000, py000), p00, (px200, py200), p000, (cx000, cy000), (
                                    x100, y100), filled_polygon000, right_line000, left_line000 = self.placement3(
                                    angle,
                                    polygon.coordinates,
                                    convex_region,
                                    dist_temp, dist)
                                copied9 = copy.deepcopy(polygon)
                                copied9.set_coordinates(filled_polygon000.exterior.coords)
                                another_list.append(copied9)
                                ...
                                """
                                sign_yes_ver2 = True
                                check_co = polygon.move_item_by_dis_and_angle_value(dist, angle)
                                pol_check = Polygon(check_co)
                                if pol_check.within(pol1):
                                    polygon.move_item_by_dis_and_angle(dist, angle)
                                else:
                                    #x_temp, y_temp = self.calculate_centroid(polygon.coordinates)

                                    #t_mpx, t_mpy = self.find_weighted_point(x_temp,y_temp,x,y,0.3)
                                    polygon.move_item(x, y)
                            else:
                                break
                        angle_temp = None
                        ...
                        if sign_yes_ver2:
                            print("does it ho here",dex)
                            points = self.check_if_line_cross(previous_polygon, copied20)
                            mid_p_o_p = self.calculate_centroid(copied20.coordinates)
                            ...
                            for point in points:
                                ...
                                if flag_temp:
                                    flag2_temp, d12_temp, d22_temp, d32_temp, d42_temp, d52_temp, d62_temp, extended_poly2_temp, right_li2_temp, left_li2_temp = self.placement2(
                                        ...
                                        copied20.coordinates,
                                        previous_polygon)
                                    left_line2 = left_li2_temp
                                    right_line2 = right_li2_temp
                                    extended_pol2 = extended_poly2_temp
                                    break
                        ...
                        if sec_flag:
                            ...
                            polygon.move_from_to2(f_p, t_p)
                            another_list.append(polygon)
                            the_point, sec_point, left_list = self.check_ep(angle, polygon, middle_point_of_poly)
                            ...
                            if dex >= 50:
                                temp_list1 = []
                                temp_list1.append(horizontal_line)
                                temp_list1.append(vertical_line)
                                draw_instance = Draw(self.container_instance, another_list, (1, 1), (1, 1), (1, 1),
                                                     (1, 1),
                                                     None,
                                                     None,
