                                ...
                                if j_index == 1:
                                    ...
                                    if (edge_point is None) or first_choice:
                                        ...
                                        if dex >= 33000:
                                            ...
                                            p_li.append(vertical_line)
                                            p_li.append(horizontal_line)
                                            p_li.append(list((pol_check2.intersection(pol1.exterior)).coords))
                                            p_li.append([p_of_c, (new_x, new_y)])
                                            p_pi = []
                                            ...
                                            copied28.set_coordinates(convex_region)
                                            p_temp = (Polygon(previous_polygon.coordinates)).buffer(0.1)
                                            copied29 = copy.deepcopy(polygon)
                                            copied29.set_coordinates(p_temp.exterior.coords)
                                            an = []
                                            an.append(copied27)
                                            an.append(copied28)
                                            an.append(copied29)
                                            ...
                                            draw_instance = Draw(self.container_instance, an, (1, 1), (1, 1),
                                                                 (1, 1),
                                                                 (1, 1),
                                                                 p_pi,
                                                                 None,
