                        ...
                        while not flag000:
                            ...
                            if dex >= 30000:
                                ...
                                vx, vy = (
                                    math.cos(math.radians(angle)), math.sin(math.radians(angle)))
                                dime = self.container_instance.calculate_total_dimensions()
                                #ap.append(line_of_newlinestring)
                                lili = []
                                ...
                                copied90.set_coordinates(fill_line.exterior.coords)
                                another_list.append(copied90)
                                empt = []
                                empt.append(copied90)

                                draw_instance = Draw(self.container_instance, empt, (1, 1), (1, 1), (1, 1),
                                                     (1, 1),
                                                     None,
                                                     None,
                                                     None, None)
