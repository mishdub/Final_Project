...
class Algo49:
    ...
    def plot(self):
        ...
        convex_region_var2 = self.container_instance.coordinates
                ...
                if dex >= 1 and not pal_c:
                    ...
                    while not flag_temp:
                            ...
                            for point in points:
                                ...
                                if j_index == 0:
                                    while True:
                                        print("here?")
                                        temp_a = a
                                        a, b, c = self.check_ep_rec_new(angle, previous_polygon, point)
                                ...
                                if j_index >= 1:
                                    while True:
                                        ...
                                        if a == temp_a and a is not None:
                                            a, b, c = self.check_ep3_without_rec(angle, previous_polygon, point, a)
                                        angle = self.calculate_angle_in_degrees(point, a)
                                        if True:
                                            dime = self.container_instance.calculate_total_dimensions()
                                            xx, yy = point
                                        ...
                                        if dex >= 165 and j_index == 1:
                                            pl = []
                                            pl2 = []

                                            another_list.append(polygon)
                                            pl.append([point, (xxx, yyy)])
                                            pl2.append(point)
                                            pl2.append(point)
                                ...
                                if dex >= 1650 and j_index == 1:
                                    pl = copy.deepcopy(polygon)
                                    pl2 = copy.deepcopy(polygon)

                                    pex = previous_polygon.extend_polygon(1.1)
                                    pl.set_coordinates(list(extended_poly.exterior.coords))
                                    pl2.set_coordinates(pex)
                                    ppl = []
                                    ppl2 = []
                                    ppl2.append(l_line)
                                    ppl.append(a)

                                    #print("does it",(Polygon(pex)).intersects(extended_polygon))


                                    another_list.append(pl)
                                    another_list.append(polygon)
                                    another_list.append(pl2)
                        ...
                        if sec_flag:
                            ...
                            """
                            centeroid_prev = self.calculate_centroid(previous_polygon.coordinates)
                            centeroid_pol = self.calculate_centroid(polygon.coordinates)
                             
                            angle_of_centroids = self.calculate_angle_in_degrees(centeroid_pol, centeroid_prev)
                            ...
                            f_p_center, t_p_center, list_of_lines, list_of_points = self.place_poly(polygon, extended_poly_center,
                                                                                      convex_region, angle_of_centroids, right_li_center,
                                                                                      left_li_center)

                            polygon.move_from_to2(f_p_center, t_p_center)
                            """
