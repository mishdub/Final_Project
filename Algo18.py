                ...
                if dex >= 1:
                    ...
                    while not flag_temp:
                        ...
                        while not flag000:
                            for index in range(2):
                                ...
                                for point in points:
                                    ...
                                    if dex >= 10000:
                                        print("which index is this",index)
                            ...
                            if dex >= 10000:
                                ...
                                draw_instance.plot()
                            if not new_flag or sec_new_flag:
                                print("*************************************************8")
                        ...
                        if sec_flag:
                            ...
                            tri = Polygon(triangle_list[tri_index])
                            tri_next = Polygon(triangle_list[((tri_index+1) % len(triangle_list))])
                            pol_for_check = Polygon(polygon.coordinates)
                            if leftest_p.within(pol1):
